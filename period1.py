...
for i in range(N):
    ...
    text_qst='Определите <B>линейную</B> частоту, если  период равен %g %sсекунд' % (Tprn,test.SiPrefixRUSfull[unit_indx])
...
test.SaveTest('period1.txt',tst)
test.SaveTestInHtml('period1.htm', tst)
